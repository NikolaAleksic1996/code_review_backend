...
All URIs are relative to *http://172.17.23.239:8000*

Class | Method | HTTP request | Description
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**messagesGet**](docs/Api/DefaultApi.md#messagesget) | **GET** /messages | Get Messages
*DefaultApi* | [**messagesSendGet**](docs/Api/DefaultApi.md#messagessendget) | **GET** /messages/send | Send a Message
